...
namespace medical_app_db.EF.Migrations
{
    ...
    [Migration("20250623131833_AddComplaintToApplointemt")]
    partial class AddComplaintToApplointemt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("medical_app_db.Core.Models.Doctor_Module.Specialization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("medical_app_db.Core.Models.Order_Module.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("medical_app_db.Core.Models.Order_Module.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("SystemProductImage")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal>("SystemProductPrice")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("medical_app_db.Core.Models.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("medical_app_db.Core.Models.Doctor_Module.Prescription", b =>
                {
                    b.HasOne("medical_app_db.Core.Models.Doctor_Module.Appointment", "Appointment")
                        ...
                        .HasForeignKey("medical_app_db.Core.Models.Doctor_Module.Prescription", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("medical_app_db.Core.Models.Order_Module.OrderItem", b =>
                {
                    b.HasOne("medical_app_db.Core.Models.Order_Module.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("medical_app_db.Core.Models.Doctor_Module.Doctor", b =>
                {
                    ...
                    b.HasOne("medical_app_db.Core.Models.Doctor_Module.Specialization", "Specialization")
                        .WithMany()
