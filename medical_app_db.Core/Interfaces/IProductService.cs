...
namespace medical_app_db.Core.Interfaces
{
    ...
    {
        Task<IEnumerable<SystemProductDTO>> GetAllSystemProductAsync(int page, int pageSize, string search);

     
        Task<IEnumerable<SystemProductWithBranchInfoDTO>> GetAllSystemProductsAsync(int page, int pageSize, string search);
